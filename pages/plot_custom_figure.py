...
def animate_figure(var, eq):
    ...
    # running animation
    figure_animation = ani.animation(ff.custom(lop, 10), e, v, False, 120, 120, 0, 10)
    components.html(figure_animation.to_jshtml(), height=1000)


st.header("Plot custom figure")
...
animate_figure(variables, equations)
